...
/**
 * One server one client and one thousand puts
 * @author jeff
 * 
 */
public class PerformanceTest1 {
	...
	static{
		try {
			new LogSetup("logs/testing/PerformanceTest"+new Date()+".log", Level.OFF);
		} catch (IOException e) {
	...
	public void OneServerOneClientThousandPut(){
		...
		System.out.println("One server one client one thousand put execution time:\n"+(endTime-startTime)+"ms");
	}
}
